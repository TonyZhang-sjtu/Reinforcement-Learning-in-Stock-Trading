...
def DRL_prediction(df,
    ...
    df_last_state.to_csv('results_5000/last_state_{}_{}.csv'.format(name, i), index=False)
...
def get_validation_sharpe(iteration):
    ...
    # # 读取与当前迭代相关的验证结果文件
    df_total_value = pd.read_csv('results_5000/account_value_validation_{}.csv'.format(iteration), index_col=0)
